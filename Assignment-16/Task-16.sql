...
(1, 'sam', 'abc@1234.gmail.com', '2025-10-16'),
(2, 'Hari', 'defh@gmail.com', '2025-10-10'),
(3, 'Anjam', 'fghi@gmail.com', '2025-10-24');

INSERT INTO Books (book_id, title, author, available) VALUES
(110, 'Atomic Habits', 'James Clear', TRUE),
(120, 'Rich kid Poor kid', 'Robert Kiyosaki', TRUE),
(130, 'The Power of Habit', 'Charles Duhigg', FALSE),
(140, 'The Athlete', 'Paulo Coelho', TRUE);
